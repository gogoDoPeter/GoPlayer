...
public class MyRender implements GLSurfaceView.Renderer {
    ...
    public void setYUVRenderData(int width, int height, byte[] y, byte[] u, byte[] v)
    {
        ...
        this.yBuffer = ByteBuffer.wrap(y);
        this.uBuffer = ByteBuffer.wrap(u);
        this.vBuffer = ByteBuffer.wrap(v);
    }

    private void renderYUV()
    {
        if(width_yuv > 0 && height_yuv > 0 && yBuffer != null && uBuffer != null && vBuffer != null)
        {
